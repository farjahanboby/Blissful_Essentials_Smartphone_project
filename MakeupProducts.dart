...
class Product1 {
  ...
  Product1({required this.imagePath, required this.name, required this.price});
}
List<Product1> products = [
  Product1(
    imagePath: 'assets/makeup.png', // Replace with actual image path
    name: 'Product 1',
    price: 19.99,
  ),
  Product1(
...
class MakeupProduct extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemBuilder: (context, index) {
          Product1 product = products[index]; // Make sure 'Product' is the correct type
